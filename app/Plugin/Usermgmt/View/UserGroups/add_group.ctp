...
$this->Html->addCrumb('Add Group', '/addGroup');
?>
<div class="umtop">
		...
		<div class="um_box_mid_content">
			...
			<div class="um_box_mid_content_mid" id="addgroup">
				...
				<div>
					...
					<div class="umstyle7">E.g. Business_User (Must not contain spaces)</div>
					<div style="clear:both"></div>
				</div>
                <?php $this->request->data['UserGroup']['allowRegistration']=true;
                /*
                <div>
                ...
                */?>
				...
				<div>Note: If you add a new group then you should allocate permissions to the newly created group.</div>
