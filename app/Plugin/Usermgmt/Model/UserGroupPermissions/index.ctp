...
$this->Html->addCrumb('User Group Permissions', '/permissions');
?>
<div class="umtop">
		...
		<div class="um_box_mid_content">
			<div class="um_box_mid_content_top">
				...
				<div style="float:right">
					<span  class="umstyle2"><?php __('Select page');?></span>  <?php echo $this->Form->input("controller",array('type'=>'select','div'=>false,'options'=>$allControllers,'selected'=>$c,'label'=>false,"onchange"=>"window.location='".SITE_URL."permissions/?c='+(this).value"))?>
				</div>
