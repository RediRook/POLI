...
<div id="step-1">
    ...
    <?php
		...
		'label' => 'Please specify other family members who already registered with Polaron'));
		
		echo $this->Form->input('Clientcase.required_contact', array(
                    'id' => 'contact',
                    'class' => 'contact',
                    'type' => 'radio',
                    'options' => array(
