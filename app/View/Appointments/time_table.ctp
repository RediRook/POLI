...
<table cellpadding="2" cellspacing="2" width="100%" id='example'>
    ...
    <?php foreach ($appointments as $appointment): ?>
        <tr class='listeven'>
            ...
            <td>
                <?php foreach($appointment['Service'] as $service): ?>
                    <?php echo $service['name']; ?>
                    &nbsp;
                <?php endforeach; ?>
            </td>
            <td>
                <?php foreach($appointment['Employee'] as $employee): ?>
            ...
            <td>
                <?php echo $this->Html->image("View.png", array('url'=>(array('controller'=>'appointments','action' => 'viewAppointment', $appointment['Appointment']['id']))));?>
            </td>
        </tr>
    <?php endforeach; ?>
</table>
