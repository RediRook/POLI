...
if (!empty($loggedUser['User']['type']) && $loggedUser['User']['type'] == 'Employee') {
    ...
    <div class="home">
        ...
        <div class="row">
            <div class="span5">
                <h3><?php echo __('Incomplete Tasks Assigned to You'); ?></h3>
                ...
                <table>
                    ...
                    <tbody>
                        <?php foreach ($tasks as $task): ?>
                            <tr class="list">
                                <td valign="top">
                                    <?php echo h($this->text->truncate($task['ResearchTask']['description'], 50, array('ellipsis' => '...'))); ?>
                                </td>
                                <td valign="top">
                                    <?php echo h($task['ResearchTask']['expected_completion_date']); ?>
                                </td>
                                <td valign="top">
                                    <?php echo h($task['ResearchTask']['status']); ?>
                                </td>
                                <td valign="btn">
                                        <div class="actions">
                ...
                ?>
                <h3><?php echo __('There are no tasks assigned to you'); ?></h3>
                <?php
            }
            ?>
        </div>
