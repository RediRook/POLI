...
$this->Html->addCrumb('Add Research Step', '/ResearchSteps/add/' . $id);
?>
<script>
    $(function() {
        ...
        <td>
            ...
            <select id="templates" >
                ...
                <?php foreach ($templates as $template): ?>
                    <option value="<?php echo $template['Templatestep']['id'] . ' ' . $id ?>" onClick="javascript:location.href = this.value;"><?php echo $template['Templatestep']['title'] ?></option>
                <?php endforeach ?>
            </select>
...
<div class="researchSteps form">
    ...
    <fieldset>
        <h3>Create a New Research Step</h3>
        <?php
        ...
        <div class="input">
            ...
            <select name="data[ResearchStep][responsible_id]">
...
<script>
    $(document).ready(function() {
        $("#templates").change(function() {
            ...
            location.href = firstPart + '/ResearchSteps/use_template/' + ident;
            document.getElementById('ID').value = firstPart + '/ResearchSteps/use_template/' + ident;// Redirects
        });
    });
</script>
</div>
