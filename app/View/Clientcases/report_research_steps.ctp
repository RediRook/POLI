...
<?php $this->Html->addCrumb('Research Step Reporting', '/clientcases/reportResearchSteps'); ?> 
<script>
...
<h2>Employees Responsible for Research Steps</h2>

<?php echo $this->form->create('reportSteps'); ?>
<fieldset>
...
<?php if ($data['created/complete'] != null) { ?>
    ...
    <tbody>
        ...
        <tr>
        <td valighn="top">
            <?php echo $this->text->truncate($step['ResearchStep']['description'], 20, array('ellipses' => '...')); ?>
        </td>
        <td valighn="top">
            <?php echo $step['ResearchStep']['creation_date']; ?>
        </td>
        <?php if ($data['created/complete'] == 'completion') { ?>
            <td valighn="top">
                <?php echo $step['ResearchStep']['completion_date']; ?>
            </td>
        <?php } ?>
        <?php if ($data['created/complete'] == 'creation') { ?>
            <td valighn="top">
                <?php echo $step['ResearchStep']['expected_completion_date']; ?>
            </td>
        <?php } ?>
        <td valighn="top">
            <?php echo $step['responsibleEmployee']['first_name'] . ' ' . $step['responsibleEmployee']['surname']; ?>
        </td>
        <?php if ($data['created/complete'] == 'completion') { ?>
            <td valighn="top">
                <?php echo $this->text->truncate($step['ResearchStep']['actual_outcome'], 20, array('ellipses' => '...')); ?>
            </td>
        <?php } ?>
        <?php if ($data['created/complete'] == 'creation') { ?>
            <td valighn="top">
                <?php echo $this->text->truncate($step['ResearchStep']['desired_outcome'], 20, array('ellipses' => '...')); ?>
            </td>
        <?php } ?>
        </tr>
    <?php endforeach ?>
