...
<div class="row col-sm-12">
	...
	<div class="row col-sm-12">
		...
		<div class="col-sm-3">
			...
			<br />
			<br />
			<label for="start">Start Time: </label><select name="start" style="position:absolute;right:10px;" disabled="true" ><option value="">Select Start Time</option></select>

			<br />
			<label for="end">End Time: </label><select name="end" style="position:absolute;right:10px;" disabled="true" ><option value="">Select End Time</option></select>
		</div>
		<div class="col-sm-3">
