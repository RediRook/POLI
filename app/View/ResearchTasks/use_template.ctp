...
$this->Html->addCrumb('Create Research Task', '/ResearchTasks/use_template/' . $id);
?>
<script>
    $(function() {
...
<div class="researchTasks form">
    ...
    <fieldset>
        <h3><?php echo $template['TemplateTask']['title']; ?></h3>
        <?php
        echo $this->Form->input('description', array('type' => 'textarea', 'style' => 'width: 900px', 'value' => $template['TemplateTask']['description']));
        ?>
        ...
        echo $this->Form->input('desired_outcome', array('type' => 'textarea', 'style' => 'width: 900px', 'value' => $template['TemplateTask']['desired_outcome']));
        ?>
