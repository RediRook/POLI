						...
						<nav class="navbar navbar-default" role="navigation">
							...
							<div class="collapse navbar-collapse navbar-ex1-collapse">
								<ul class="nav navbar-nav">
									<li><?php echo $this->Html->link('Home','/users/customer');?></li>
									<li><?php echo $this->Html->link('Service','/services/serviceIndex');?></li>
									<li><?php echo $this->Html->link('Staff','/staffs/staffIndex');?></li>

	                                <li><?php echo $this->Html->link('News','/news/customerView');?></li>
									<li><?php echo $this->Html->link('Job','/jobs/timeTable');?></li>
								</ul>
