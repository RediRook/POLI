						...
						<nav class="navbar navbar-default" role="navigation">
							...
							<div class="collapse navbar-collapse navbar-ex1-collapse">
								<ul class="nav navbar-nav">
									<li>
										<?php 
											echo $url = $this->Html->link('Home','/'); 
											echo $active = $this->request->here == $url? true: false;
										?>
									</li>
									<li><?php echo $this->Html->link('Service','/pages/service');?></li>
									<li><?php echo $this->Html->link('Staff','/pages/staff');?></li>
									<li><?php echo $this->Html->link('History','/pages/history');?></li>
									<li><?php echo $this->Html->link('Gallery','/pages/gallery');?></li>
									<li><?php echo $this->Html->link('Contact us','/contact');?></li>
									<li><?php echo $this->Html->link('Recommended','/pages/trades');?></li>
								</ul>
